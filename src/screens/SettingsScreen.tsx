...
const SettingsScreen: React.FC = () => {
  ...
  const handleSupportPress = () => {
    Linking.openURL('mailto:support@subtrackr.app');
  };

  const handlePrivacyPress = () => {
    Linking.openURL('https://subtrackr.app/privacy');
  };

  const handleTermsPress = () => {
    Linking.openURL('https://subtrackr.app/terms');
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <Card style={styles.section}>
          ...
          <TouchableOpacity style={[styles.linkRow, styles.linkRowLast]} onPress={handleTermsPress}>
