...
const AnalyticsScreen: React.FC = () => {
  ...
  const monthlyData = useMemo(() => {
    ...
    let dataMonths: string[];
    if (dateRange === 'week') {
      dataMonths = ['Week 1', 'Week 2', 'Week 3', 'Week 4'];
    } else if (dateRange === 'month') {
      dataMonths = months.slice(0, currentMonth + 1);
    } else {
      dataMonths = months;
    }
  ...
  const totalMonthly = stats.totalMonthlySpend;
  const totalYearly = stats.totalYearlySpend;
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.summaryContainer}>
          ...
          <Card style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>${totalYearly.toFixed(2)}</Text>
          </Card>
        </View>
        ...
        <Card style={styles.projectionCard}>
          ...
          <View style={styles.projectionItem}>
            ...
            <Text style={styles.projectionValue}>${totalMonthly.toFixed(2)}</Text>
          </View>
          <View style={styles.projectionItem}>
            <Text style={styles.projectionLabel}>Next 90 Days</Text>
            <Text style={styles.projectionValue}>${(totalMonthly * 3).toFixed(2)}</Text>
          </View>
          <View style={[styles.projectionItem, styles.projectionItemLast]}>
            <Text style={styles.projectionLabel}>Next 12 Months</Text>
            <Text style={styles.projectionValue}>${totalYearly.toFixed(2)}</Text>
          </View>
        </Card>
      </ScrollView>
    </SafeAreaView>
