/**
 * networkSlice.ts — Network slice for the slices-pattern store.
 */
...
export type NetworkStoreState = AppState;

export const createNetworkSlice: SliceCreator<NetworkSlice> = (set) => ({
  currentNetwork: null,
